...
const dict = {
  ...
  env_performance_body: {
    en: "Designed to outperform most comparable wool coats across environmental and durability measures, this coat ranks among the top 10% for environmental performance — the numbers above tell most of that story.",
    fr: "Conçu pour surpasser la plupart des manteaux en laine comparables en matière d'impact environnemental et de durabilité, ce manteau se classe parmi les 10% les plus performants — les chiffres ci-dessus racontent l'essentiel de cette histoire.",
    pt: "Projetado para superar a maioria dos casacos de lã comparáveis em medidas ambientais e de durabilidade, este casaco está entre os 10% melhores — os números acima já contam a maior parte dessa história.",
  },
